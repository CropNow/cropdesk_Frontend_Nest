...
export const alertsAPI = {
   ...
   * Get alert by ID
   */
  getAlert: (alertId: string) => apiClient.get(`/alerts/${alertId}`),
  ...
  getAlertHistory: (farmId: string, limit?: number, offset?: number) =>
    apiClient.get(`/alerts/farm/${farmId}/history`, {
      params: { limit, offset },
    }),
   ...
   */
  getFISAlerts: (farmId: string) => apiClient.get(`/alerts/farm/${farmId}/fis`),
