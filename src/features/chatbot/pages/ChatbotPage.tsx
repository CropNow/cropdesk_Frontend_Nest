        ...
        <div className="flex flex-1 flex-col overflow-hidden rounded-[2.5rem] border border-cardBorder bg-cardBg/40 backdrop-blur-xl">
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
            {messages.map((msg) => (
              ...
              >
                <div
                  className={`flex max-w-[80%] gap-3 ${msg.sender === "user" ? "flex-row-reverse" : ""}`}
                >
                  <div
                  ...
                  <div
                    className={`rounded-2xl px-4 py-2.5 text-sm sm:text-base shadow-sm ${
                      msg.sender === "user"
                  ...
                  >
                    {msg.text}
                    <div
                      className={`mt-1 text-[10px] opacity-40 ${msg.sender === "user" ? "text-right" : "text-left"}`}
                    >
