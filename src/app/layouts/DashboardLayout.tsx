...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  return (
    <main className="relative min-h-screen overflow-hidden bg-bgMain px-4 pb-10 pt-8 text-textHeading sm:px-6 sm:pt-8 desktop-layout-pl lg:pr-8 lg:pt-2 transition-all duration-300">
      <a
        href="#main-content"
      ...
      <div id="main-content" className="relative z-10 mx-auto max-w-[1400px] space-y-6">
        {children}
      </div>
    </main>
  );
