...
<<<<<<< Updated upstream
  const handleAddSuccess = (newDevice: any) => {
    onAdd(newDevice);
    setShowWizard(false);
    refreshDevices(newDevice.fieldId);
=======
...
export function DeviceOnboardingWizard({ onClose, onSuccess }: DeviceOnboardingWizardProps) {
    ...
    <div className="fixed inset-0 z-[130] flex items-center justify-center bg-black/70 p-4 backdrop-blur-md">
      <div className="max-h-[96vh] w-full max-w-6xl overflow-y-auto rounded-[2rem] border border-cardBorder bg-bgSidebar">
        ...
        <div className="space-y-5 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWizardData((prev) => ({ ...prev, farmerName: e.target.value }))}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, emailAddress: e.target.value }))}
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, district: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, farmerState: e.target.value }))}
                    placeholder="State"
                    className="w-full rounded-xl border border-cardBorder bg-bgInput px-4 py-3 text-lg text-textHeading outline-none"
                  />
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, farmName: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, addressLine: e.target.value }))}
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, zipCode: e.target.value }))}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, soilType: e.target.value }))}
                    className="w-full rounded-xl border border-cardBorder bg-bgInput px-4 py-3 text-lg text-textHeading outline-none"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, irrigationType: e.target.value }))}
                    className="w-full rounded-xl border border-cardBorder bg-bgInput px-4 py-3 text-lg text-textHeading outline-none"
                  >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setWizardData((prev) => ({ ...prev, farmingType: e.target.value }))}
                  className="w-full rounded-xl border border-cardBorder bg-bgInput px-4 py-3 text-lg text-textHeading outline-none"
                >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWizardData((prev) => ({ ...prev, fieldName: e.target.value }))}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, area: e.target.value }))}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, boundaryType: e.target.value }))}
                    className="w-full rounded-xl border border-cardBorder bg-bgInput px-4 py-3 text-lg text-textHeading outline-none"
                  >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWizardData((prev) => ({ ...prev, cropName: e.target.value }))}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, plantingDate: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, expectedHarvest: e.target.value }))}
                    className="w-full rounded-xl border border-cardBorder bg-bgInput px-4 py-3 text-lg text-textHeading outline-none [color-scheme:dark]"
                  />
                </div>
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWizardData((prev) => ({ ...prev, cultivationArea: e.target.value }))}
          ...
          {step === 5 && (
            <div className="space-y-4">
              <h4 className="text-xl font-semibold text-textHeading">Device Info</h4>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, type: e.target.value as DeviceKind }))}
                    className="w-full rounded-xl border border-cardBorder bg-bgInput px-4 py-3 text-lg text-textHeading outline-none"
                  >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, manufacturer: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, model: e.target.value }))}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, status: e.target.value as 'Connected' | 'Offline' }))}
                    className="w-full rounded-xl border border-cardBorder bg-bgInput px-4 py-3 text-lg text-textHeading outline-none"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setWizardData((prev) => ({ ...prev, firmware: e.target.value }))}
                        ...
                        >
                          ...
                          <FeatureGroup>
                            <GeomanControls
                              ...
                              onMapRemove={() => {
                                setWizardData((prev) => ({ ...prev, boundaryCoordinates: [] }));
                              }}
                            />
                          </FeatureGroup>
                        </MapContainer>
