...
const DEFAULT_GLOW_COLOR = '0, 255, 156';
...
export function BentoCard({
  ...
  }, [animateParticles, clearAllParticles, shouldDisable, enableTilt, enableMagnetism, clickEffect, glowColor, enableParticles]);

  return (
    <div
      ref={cardRef}
      className={`bento-card relative overflow-hidden ${enableBorderGlow ? 'bento-card--border-glow' : ''} ${className}`}
      style={{
        position: 'relative',
        overflow: 'hidden',
        '--glow-x': '50%',
