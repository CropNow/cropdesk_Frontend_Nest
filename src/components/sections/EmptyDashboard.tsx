      ...
      <div className="mt-4 grid gap-6">
        ...
        <div className="grid gap-6 xl:grid-cols-[1fr_1.2fr]">
          ...
          >
            <Card
              variant="glass"
              className="flex min-h-[360px] flex-col items-center justify-center p-8 text-center transition-all hover:border-accentPrimary/20 hover:bg-cardBg/60"
            >
              <button
              ...
              <h3 className="mt-8 text-3xl font-bold text-textHeading tracking-tight">
                No devices connected
              </h3>
              <p className="mt-3 max-w-[320px] text-lg text-textSecondary/80">
