...
export function RegisterPage() {
  ...
  const steps = [
    { n: 1, label: 'Sign up your', sub: 'account', active: true },
    { n: 2, label: 'Set up your', sub: 'workspace', active: false },
    { n: 3, label: 'Set up your', sub: 'profile', active: false },
  ];
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                <label className="mb-1.5 block text-xs font-medium text-textLabel">First Name</label>
                <input
                  type="text"
                  placeholder="eg. John"
                  value={firstName}
            ...
            {/* Confirm Password */}
            <div>
              <label className="mb-1.5 block text-xs font-medium text-textLabel">Confirm Password</label>
              <div className="relative">
                <input
